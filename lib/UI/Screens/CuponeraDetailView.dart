...
class CuponeraDetailView extends StatefulWidget{
  @override
  State createState() {
    return _CuponeraDetailView();
  }
}
class _CuponeraDetailView extends State<CuponeraDetailView>{
  @override
        ...
        child: Column(
          children: [
            ...
            Row(
              ...
              children: [
                Container(
                  child: Text("Incluye:",style: TextStyle(
            ...
            Row(
              ...
              children: [
                ...
                Column(
                  children: [
                    Container(
                      child: Text("-Este es un texto referencial",style: TextStyle(
                        color: Colors.black,
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text("Descargar cupon",style: TextStyle(
                          color: Colors.white,
