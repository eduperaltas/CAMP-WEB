...
class ProfesionalProfileView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _ProfesionalProfileView createState() => _ProfesionalProfileView();
}

class _ProfesionalProfileView extends State<ProfesionalProfileView> {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(left: MediaQuery.of(context).size.height*0.015, top:MediaQuery.of(context).size.height*0.001 ),
                          child: TextFormField(
                            autofocus: true,
                            autocorrect: true,
                            //textAlign: TextAlign.center,
                      ...
                      Container(
                        ...
                        child: Padding(
                          padding: EdgeInsets.only(left: MediaQuery.of(context).size.height*0.015, top:MediaQuery.of(context).size.height*0.002 ),
                          child: TextFormField(
                            autofocus: true,
                            autocorrect: true,
                            //textAlign: TextAlign.center,
                      ...
                      Container(
                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            validator: (input)=> input.isEmpty ? 'Ingresa un teléfono valido' : null,
                            onChanged: (val){
                              //setState(() => _email = val);
                            },
