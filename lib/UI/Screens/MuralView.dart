...
class _MuralView extends State<MuralView>{
  @override
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            image: DecorationImage(
                                fit: BoxFit.fill,
                                image: AssetImage("assets/images/noticia 2.png")
                            ),
                          ),
                        ),
                        SizedBox(
                        ...
                        Container(
                          ...
                          child: Center(
                            child: Text("Es simplemente el texto de relleno de las imprentas y archivos de texto. cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen.",style:TextStyle(
                                fontSize: MediaQuery.of(context).size.width*0.012,
                                //fontWeight: FontWeight.w400,
                                color: Colors.black,
                                height: 1.5
