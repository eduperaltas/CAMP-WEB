...
class ListaContactosDetailView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _ListaContactosDetailView createState() => _ListaContactosDetailView();
}

class _ListaContactosDetailView extends State<ListaContactosDetailView> {
                ...
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      height: MediaQuery.of(context).size.height*0.05,
                      child: Text("Empresa: XXXXXXXXXXXXXXXXXXX", style: TextStyle(
                    ...
                    Container(
                      ...
                      width: MediaQuery.of(context).size.width*0.3,
                      height: MediaQuery.of(context).size.height*0.05,
                      child: Text("Cargo: XXXXXXXXXXXXXXXXXXX", style: TextStyle(
                          fontWeight: FontWeight.w400,
                          fontSize: MediaQuery.of(context).size.height*0.015
                      ),),
                    ),
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        onTap: (){
                          ...
                          Navigator.push(context, PageTransition(child: ContactosDetailView(), type: PageTransitionType.rightToLeft));
