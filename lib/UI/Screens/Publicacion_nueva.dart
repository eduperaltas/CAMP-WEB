...
class PublicacionesNuevaView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _PublicacionesNuevaView createState() => _PublicacionesNuevaView();
}

class _PublicacionesNuevaView extends State<PublicacionesNuevaView> {
