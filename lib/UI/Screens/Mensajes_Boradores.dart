...
import 'package:camp_web/UI/Screens/ComprasOnline.dart';
...
import 'Mensajes_Notificaciones.dart';
...
class MensajesBorradoresView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _MensajesBorradoresView createState() => _MensajesBorradoresView();
}

class _MensajesBorradoresView extends State<MensajesBorradoresView> {
