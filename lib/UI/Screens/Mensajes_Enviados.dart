...
class MensajesEnviadosView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _MensajesEnviadosView createState() => _MensajesEnviadosView();
}

class _MensajesEnviadosView extends State<MensajesEnviadosView> {
