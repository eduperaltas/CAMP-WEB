...
class MensajesPapelerasView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _MensajesPapelerasView createState() => _MensajesPapelerasView();
}

class _MensajesPapelerasView extends State<MensajesPapelerasView> {
