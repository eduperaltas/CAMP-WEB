...
class PreguntasFrecuentesView extends StatefulWidget{
  @override
  State createState() {
    return _PreguntasFrecuentesView();
  }
}
class _PreguntasFrecuentesView extends State<PreguntasFrecuentesView>{
  @override
