...
class MensajesDetailView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _MensajesDetailView createState() => _MensajesDetailView();
}

class _MensajesDetailView extends State<MensajesDetailView> {
