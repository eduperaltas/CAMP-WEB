...
class ContactosView extends StatefulWidget {
  ...
  @override
  _ContactosView createState() => _ContactosView();
}

class _ContactosView extends State<ContactosView> {
                      ...
                      MouseRegion(
                        ...
                        child: GestureDetector(
                          onTap: (){
                            ...
                            Navigator.push(context, PageTransition(child: ListaContactosDetailView(), type: PageTransitionType.rightToLeft));
                      ...
                      Row(
                        ...
                        children: [
                          MouseRegion(
                            ...
                            child: GestureDetector(
                              onTap: (){
                                Navigator.push(context, PageTransition(child: AgregarContactosView(), type: PageTransitionType.rightToLeft));
                              },
                              child: Container(
