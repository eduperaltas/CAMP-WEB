...
class TalleresEventosVIewDetail extends StatefulWidget{
  @override
  State createState() {
    return _TalleresEventosVIewDetail();
  }
}
class _TalleresEventosVIewDetail extends State<TalleresEventosVIewDetail>{
  @override
                  ...
                  children: [
                    Container(
                      ...
                      /*decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            fit: BoxFit.fill,
                            image: AssetImage("assets/images/shutterstock_1723547851.jpg")
                        ),
                      ),*/
                    ),
                    SizedBox(
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text("Este texto que se usa habitualmente en diseño gráfco en demostraciones de tipografías o de borradores de diseño para probar el diseño visual antes de insertar el texto nal. Este texto que se usa habitualmente en diseño gráco en demostraciones de tipografías o de borradores de diseño para probar el diseño visual antes de insertar el texto nal.Este texto que se usa habitualmente en diseño gráfico en demostraciones de tipografías o de borradores de diseñopara probar el diseño visual antes de insertar el texto nal. Este texto que se usa habitualmente en diseño gráco endemostraciones de tipografías o de borradores de diseño para probar el diseño visual antes de insertar el texto nal.",style:TextStyle(fontSize: MediaQuery.of(context).size.width*0.012,
                            //fontWeight: FontWeight.w300,
                            color: Colors.black,
                            height: 1.5
                        ),
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                child: Text("Ponente",style: TextStyle(
