...
class AgregarContactosView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _AgregarContactosView createState() => _AgregarContactosView();
}

class _AgregarContactosView extends State<AgregarContactosView> {
