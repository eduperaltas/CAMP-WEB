...
import 'Evento_nueva.dart';
import 'HomeView.dart';
import 'Mensajes_Buzon.dart';
import 'MuralView.dart';
import 'MuralViewDetail.dart';
import 'ProfileView.dart';
import 'Publicacion_nueva.dart';
import 'TalleresEventos.dart';
import 'login.dart';



class PublicacionesView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _PublicacionesView createState() => _PublicacionesView();
}

class _PublicacionesView extends State<PublicacionesView> {
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                                child: Text("Título de la publicaion I", style:
                                TextStyle(
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                                child: Text("Título de la publicaion II", style:
                                TextStyle(
                                    fontSize: MediaQuery.of(context).size.height*0.018,
                                    fontWeight: FontWeight.w500
                                ),)
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                                child: Text("Título de la publicaion III", style:
                                TextStyle(
                                    fontSize: MediaQuery.of(context).size.height*0.018,
                                    fontWeight: FontWeight.w500
                                ),)
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                                child: Text("Título de la publicaion IV", style:
                                TextStyle(
                                    fontSize: MediaQuery.of(context).size.height*0.018,
                                    fontWeight: FontWeight.w500
                                ),)
                    ...
                    MouseRegion(
                      ...
                      child: GestureDetector(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                                child: Text("Título de la publicaion V", style:
                                TextStyle(
                                    fontSize: MediaQuery.of(context).size.height*0.018,
                                    fontWeight: FontWeight.w500
                                ),)
                    ...
                    MouseRegion(
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: (){
                              Navigator.push(context, PageTransition(child: PublicacionesNuevaView(), type: PageTransitionType.rightToLeft));
                            },
                            child: Container(
                    ...
                    MouseRegion(
                      ...
                      child: Row(
                        ...
                        children: [
                          GestureDetector(
                            onTap: (){
                              Navigator.push(context, PageTransition(child: EventosNuevaView(), type: PageTransitionType.rightToLeft));
                            },
                            child: Container(
