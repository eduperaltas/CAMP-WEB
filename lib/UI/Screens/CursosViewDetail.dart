...
class CursosViewDetail extends StatefulWidget{
  @override
  State createState() {
    return _CursosViewDetail();
  }
}
class _CursosViewDetail extends State<CursosViewDetail>{
  @override
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      width: 620,
                      child: Text("Nombre del Curso", style: TextStyle(
