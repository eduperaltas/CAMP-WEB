...
class MuralViewDetail extends StatefulWidget{
  @override
  State createState() {
    return _MuralViewDetail();
  }
}
class _MuralViewDetail extends State<MuralViewDetail>{
  @override
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Container(
                      width: 620,
                      child: Text("AGOSTO 05, 2021", textAlign: TextAlign.left, style: TextStyle(
                        color: Color(0Xff2056a1),
                    ...
                    Container(
                      width: 620,
                      child: Text("Texto referencial para colocar un título", style: TextStyle(
                    ...
                    Container(
                      ...
                      child: Center(
                        child: Text("Este texto que se usa habitualmente en diseño gráfco en demostraciones de tipografías o de borradores de diseño para probar el diseño visual antes de insertar el texto nal. Este texto que se usa habitualmente en diseño gráco en demostraciones de tipografías o de borradores de diseño para probar el diseño visual antes de insertar el texto nal.Este texto que se usa habitualmente en diseño gráfico en demostraciones de tipografías o de borradores de diseñopara probar el diseño visual antes de insertar el texto nal. Este texto que se usa habitualmente en diseño gráco endemostraciones de tipografías o de borradores de diseño para probar el diseño visual antes de insertar el texto nal.Este texto que se usa habitualmente en diseño gráco en demostraciones de tipografías o de borradores de diseñopara probar el diseño visual antes de insertar el texto nal. Este texto que se usa habitualmente en diseño gráco endemostraciones de tipografías o de borradores de diseño para probar el diseño visual antes de insertar el texto nal.Este texto que se usa habitualmente en diseño gráco en demostraciones de tipografías o de borradores de diseñopara probar el diseño visual antes de insertar el texto nal.",style:TextStyle(fontSize: MediaQuery.of(context).size.width*0.012,
                        ...
                        Column(
                          ...
                          children: [
                            Row(
                              ...
                              children: [
                                Container(
                                  child: Text("Sobre el autor", style: TextStyle(color: Colors.black,fontWeight: FontWeight.w600,fontSize: MediaQuery.of(context).size.width*0.014),),
                                ),
                                SizedBox(
                                  width: MediaQuery.of(context).size.width*0.01,
                                ),
                                Container(
                                  child: Text("Nombre Apellido", style: TextStyle(color: Colors.black,fontWeight: FontWeight.w400,fontSize: MediaQuery.of(context).size.width*0.01),),
                                ),
                              ],
                            ),
                            SizedBox(
                            ...
                            Container(
                              ...
                              child: Text("Este texto que se usa habitualmente en diseño gráfco en demostraciones de tipografías o de borradores de diseño para probar el diseño visual antes de inse",textAlign: TextAlign.justify, style: TextStyle(
                    ...
                    Container(
                      ...
                      height: MediaQuery.of(context).size.width*0.08,
                        color: Color(0Xff646464),
                      child: Center(
                        child: Text("Texto referencial para colocar el título de una nota",textAlign: TextAlign.center,style: TextStyle(
                ...
                Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                child: Text("Autor",style: TextStyle(
                          ...
                          Row(
                            children: [
                              ...
                              Container(
                                width: MediaQuery.of(context).size.width*0.1,
                                child: Text("NOMBRE APELLIDO",textAlign: TextAlign.justify, style: TextStyle(
                                  color: Colors.white,
                    ...
                    Row(
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Icon(Icons.edit, color: Colors.black,size: MediaQuery.of(context).size.width*0.02,),
                        Container(
                          width: MediaQuery.of(context).size.width*0.05,
                          child: Text("MÁS VISTAS",style: TextStyle(
                            color: Colors.black,
                            fontSize: MediaQuery.of(context).size.width*0.01,
                          ),),
                        ),
                    ...
                    Row(
                      children: [
                        ...
                        Container(
                          ...
                          child: Text("Texto referencial paracolocar un título"
                            ,style: TextStyle(
                              color: Colors.black,
                              fontSize: MediaQuery.of(context).size.width*0.015,
                            ),),
