...
class TalleresEventosView extends StatefulWidget{
  @override
  State createState() {
    return _TalleresEventosView();
  }
}
class _TalleresEventosView extends State<TalleresEventosView>{
  @override
              ...
              child:GestureDetector(
                ...
                child: GestureDetector(
                  ...
                  child: Row(
                    ...
                    image: DecorationImage(
                        fit: BoxFit.fill,
                        image: AssetImage("assets/images/shutterstock_617915060.jpg")
                    ),
                  ),*/
                      ),
                      SizedBox(
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              width: MediaQuery.of(context).size.width*0.4,
                              child: Center(
                                child: Text("Es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor (N. del T. persona que se dedica a la imprenta) desconocido usó una galería de textos y los mezcló de tal manera que logró hacer un libro de textos especimen.Es simplemente el texto de relleno de las imprentas y archivos de texto. Lorem Ipsum ha sido el texto de relleno estándar de las industrias desde el año 1500, cuando un impresor",style:TextStyle(
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Container(
                                    ...
                                    child: Text("Texto referencial para colocar el título de una noticia",textAlign: TextAlign.justify, style: TextStyle(
