...
class EventosNuevaView extends StatefulWidget {
  double collapsableHeight = 0.0;
  Color selected = Color(0Xff2056a1);
  Color notSelected = Colors.grey;
  @override
  _EventosNuevaView createState() => _EventosNuevaView();
}

class _EventosNuevaView extends State<EventosNuevaView> {
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: TextFormField(
                              ...
                              validator: (input)=> input.isEmpty ? 'Ingresa una fecha válido' : null,
                              onChanged: (val){
                                //setState(() => _email = val);
                              },
                    ...
                    Container(
                      ...
                      child: Padding(
                        ...
                        child: TextFormField(
                          ...
                          validator: (input)=> input.isEmpty ? 'Ingresa un texto válido' : null,
                          onChanged: (val){
                            //setState(() => _email = val);
                          },
